      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            className="w-full bg-zinc-900 border border-zinc-800 rounded-full py-2 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-white"
            value={searchQuery}
        ...
        <div className="flex items-center space-x-6 text-sm font-medium">
          <Link to="/" className="text-zinc-400 hover:text-white transition-colors">Browse</Link>
          <a href="#" className="text-zinc-400 hover:text-white transition-colors">Leaderboards</a>
          <a href="#" className="text-zinc-400 hover:text-white transition-colors">Request Game</a>
        </div>
      </div>
    </nav>
  );
